    ...
    return <div className="w-[100%] relative rounded-3xl overflow-hidden mt-[20px]  " >
            {/* <img src={panel} alt="" className="absolute bottom-[330px] right-[-20px] w-[150px]"/> */}
                ...
                <div className="flex flex-col items-left sm:items-center h-[100%] sm:h-[70%] sm:w-[80%] justify-center p-3 rounded-3xl my-[20px] sm:my-[0px] ">
                        <p className="text-[30px] drop-shadow-xl drop-shadow-black text-white my-4 sm:text-[35px] md:text-[45px] font-bold sm:text-white text-left sm:text-center">
                            “Reliable Solar, Smart Homes & CCTV Security for Every Nigerian Household”
                        </p>
                        <p className="text-[12px] drop-shadow-xl drop-shadow-black text-white sm:text-[20px] font-semibold  sm:text-white  sm:text-center w-[90%]">
                 ...
                 <div className="z-4 sm:h-[700px] absolute sm:static top-3.5  w-[100vw] overflow-hidden mt-[-10px] rounded-3xl ">
